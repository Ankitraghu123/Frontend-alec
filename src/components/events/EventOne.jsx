...
//     try {
//       const response = await axios.get("https://backend.aashayeinjudiciary.com/event");
...
//       ) : message.text ? (
//         <div>{message.text}</div> // Display error message
//       ) : (
//         <>
...
//                 data-wow-delay="0.3s"
//               >
//                 {contacts.slice(0, Math.ceil(contacts.length / 2)).map((course, idx) => (
//                   <div key={idx} className="td_card td_style_1 td_type_1">
//                     <Link  to={`/event-details/${course._id}`} className="td_card_thumb d-block">
//                       <img
//                         src={
//                           course.images
...
//                                 />
//                               </svg>
//                               <span>{course.StartDate || "Jan 23, 2024"}</span>
//                             </li>
//                             <li>
//                               <svg
//                                 className="td_accent_color"
...
//                 data-wow-delay="0.3s"
//               >
//                 {contacts.slice(Math.ceil(contacts.length / 2)).map((course, idx) => (
//                   <div key={idx} className="td_card td_style_1 td_type_1">
//                     <Link  className="td_card_thumb d-block"  onClick={() => handleCourseClick(contacts._id)}>
//                       <img
//                         src={
//                           course.images
//                             ? Array.isArray(course.images)
//                               ? course.images[0]
//                               : course.images
//                             : fallbackImages[(idx + Math.ceil(contacts.length / 2)) % fallbackImages.length]
//                         }
...
//                         </div>
//                         <h2 className="td_card_title td_fs_20 td_semibold td_mb_20">
//                           <Link  onClick={() => handleCourseClick(contacts._id)}>{course.Title || "Event Title"}</Link>
//                         </h2>
//                         <span className="td_card_location td_medium td_heading_color">
//                           <svg
//                             className="td_accent_color"
